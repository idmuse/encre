...
// Initialization
// Patch Encre : chemin portable au lieu du chemin ONLYOFFICE codé en dur.
if(!conj.bInit) {
    conj.init(helpers.loadFile((window.GRAMMALECTE_BASE || "vendor/grammalecte") + "/fr/conj_data.json"));
} else if (conj.bInit){
