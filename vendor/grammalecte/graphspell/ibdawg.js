        ...
        try {
            ...
            if (typeof(source) == "string") {
                ...
                if (typeof(process) !== 'undefined') {
                    ...
                    // Patch Encre : chemin portable (au lieu du remplacement
                    // "index.html" -> "vendor/grammalecte-sdk" propre au plugin
                    // ONLYOFFICE d'origine, qui ne correspond pas à notre layout).
                    sURL = (window.GRAMMALECTE_BASE || "vendor/grammalecte") + "/graphspell/_dictionaries/" + source;
                }
