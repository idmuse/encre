...
// Initialization
// Patch Encre : la version d'origine (extension WebExtension) n'avait pas de
// repli pour une page web classique — `browser` n'existe pas hors extension.
if (!mfsp.bInit) {
    mfsp.init(helpers.loadFile((window.GRAMMALECTE_BASE || "vendor/grammalecte") + "/fr/mfsp_data.json"));
} else if (mfsp.bInit){
